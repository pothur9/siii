...
export default function Navbar() {
    return (
        <div className="sticky top-0 z-50 w-full flex flex-col">
            ...
            <div className="w-full bg-gradient-to-r from-pink-600 via-purple-600 via-indigo-600 via-blue-600 via-emerald-500 via-yellow-500 via-orange-500 to-pink-600 animate-gradient-bg text-white py-2 overflow-hidden border-b border-white/10">
                <div className="w-full overflow-hidden whitespace-nowrap">
                    <div className="animate-scroll-left inline-flex gap-12 text-xs md:text-sm font-semibold tracking-wider uppercase select-none shrink-0 min-w-max hover:[animation-play-state:paused] cursor-pointer">
                        <span>🎉 Limited Time Offer: Get 50% OFF on all courses!  🎉</span>
                        <span>🚀 Boost your career with industry expert-led certification courses! 🚀</span>
                        <span>🔥 50% discount active on all live & self-paced cohorts! 🔥</span>
                        <span>✨ Learn React, Cyber Security, AI, Mobile Dev, and more! ✨</span>
            ...
            {/* Main Navbar */}
            <nav className="bg-[#0b0c1e] border-b border-gray-800 shadow-sm w-full">
